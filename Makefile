...
deploy:
	@forge script contracts/script/DeployRaffle.s.sol:DeployRaffle $(NETWORK_ARGS)

createSubscription:
	@forge script contracts/script/Interactions.s.sol:CreateSubscription $(NETWORK_ARGS)

addConsumer:
	@forge script contracts/script/Interactions.s.sol:AddConsumer $(NETWORK_ARGS)

fundSubscription:
	@forge script contracts/script/Interactions.s.sol:FundSubscription $(NETWORK_ARGS)
